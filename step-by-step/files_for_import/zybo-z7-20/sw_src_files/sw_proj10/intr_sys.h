 ...
 * Also, with nested interrupts, only the higher-priority device
 * can interrupt the lower priority device. In this project, we want the
 * timer handler to be allowed interrupt the UART handler.
 *  */

/* PS7 UART1 */
#define UART1_INTR_PRI				(0xB0) // Lower priority than TTC0

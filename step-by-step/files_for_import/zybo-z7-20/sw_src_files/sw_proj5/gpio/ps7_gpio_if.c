 ...
 * 				(1) DEVICE LOOK-UP => Calls function "XGpioPs_LookupConfig"
 * 				(2) DRIVER INIT => Calls function "XGpioPs_CfgInitialize"
 * 				(3) SELF TEST => Calls function "XGpioPs_SelfTest"
 * 				(4) SPECIFIC CONFIG => Configures PS7 GPIO
 *
...
int psGpioInit(void)
{
	...
	* -------------------------------------------------------------------- */
	...
	/* PS_GP_OUT0 */
	XGpioPs_SetDirectionPin(p_XGpioPsInst, PS_GP_OUT0, 1);
	XGpioPs_SetOutputEnablePin(p_XGpioPsInst, PS_GP_OUT0, 1);
	XGpioPs_WritePin(p_XGpioPsInst, PS_GP_OUT0, 0);
	/* PS_GP_OUT1 */
	XGpioPs_SetDirectionPin(p_XGpioPsInst, PS_GP_OUT1, 1);
	XGpioPs_SetOutputEnablePin(p_XGpioPsInst, PS_GP_OUT1, 1);
	XGpioPs_WritePin(p_XGpioPsInst, PS_GP_OUT1, 0);
	/* PS_GP_OUT2 */
	XGpioPs_SetDirectionPin(p_XGpioPsInst, PS_GP_OUT2, 1);
	XGpioPs_SetOutputEnablePin(p_XGpioPsInst, PS_GP_OUT2, 1);
	XGpioPs_WritePin(p_XGpioPsInst, PS_GP_OUT2, 0);
	/* PS_GP_OUT3 */
	XGpioPs_SetDirectionPin(p_XGpioPsInst, PS_GP_OUT3, 1);
	XGpioPs_SetOutputEnablePin(p_XGpioPsInst, PS_GP_OUT3, 1);
	XGpioPs_WritePin(p_XGpioPsInst, PS_GP_OUT3, 0);
	/* PS_GP_OUT4 */
	XGpioPs_SetDirectionPin(p_XGpioPsInst, PS_GP_OUT4, 1);
	XGpioPs_SetOutputEnablePin(p_XGpioPsInst, PS_GP_OUT4, 1);
	XGpioPs_WritePin(p_XGpioPsInst, PS_GP_OUT4, 0);
	/* PS_GP_OUT5 */
	XGpioPs_SetDirectionPin(p_XGpioPsInst, PS_GP_OUT5, 1);
	XGpioPs_SetOutputEnablePin(p_XGpioPsInst, PS_GP_OUT5, 1);
	XGpioPs_WritePin(p_XGpioPsInst, PS_GP_OUT5, 0);
	/* PS_GP_OUT6 */
	XGpioPs_SetDirectionPin(p_XGpioPsInst, PS_GP_OUT6, 1);
	XGpioPs_SetOutputEnablePin(p_XGpioPsInst, PS_GP_OUT6, 1);
	XGpioPs_WritePin(p_XGpioPsInst, PS_GP_OUT6, 0);
	/* PS_GP_OUT7 */
	XGpioPs_SetDirectionPin(p_XGpioPsInst, PS_GP_OUT7, 1);
	XGpioPs_SetOutputEnablePin(p_XGpioPsInst, PS_GP_OUT7, 1);
	XGpioPs_WritePin(p_XGpioPsInst, PS_GP_OUT7, 0);

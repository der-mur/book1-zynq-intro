#================================================================================#
# This script is compatible with the the Digilent/Avnet Zedboard, although
# the Digilent board files ("zedboard") must be in the relevant Vivado directory
# (i.e. C:\Xilinx\Vivado\<ver>\data\boards\board_files\zedboard).
# 
...
set constr_file F:/Documents/GitHub/book1-zynq-intro/step-by-step/files_for_import/zed/constraints/main_constraints.xdc

set part_name xc7z020clg484-1
set board_part_name digilentinc.com:zedboard:part0:1.0
